...
- This script should reflect or cover the equivalents of the packages listed in [deps-info.md](https://github.com/Kitty-Hivens/YukiUI/blob/main/sdata/deps-info.md).
...
For possible values, see the definition of function `outdate_detect()` in [1.deps-selector.sh](https://github.com/Kitty-Hivens/YukiUI/blob/main/sdata/subcmd-install/1.deps-selector.sh).
:::
