...
The repo of this doc site is [here](https://github.com/Kitty-Hivens/YukiUI-wiki) and it's open to contribution.
...
If you're unsure about a possible PR, you may open an [issue](https://github.com/Kitty-Hivens/YukiUI-wiki/issues) before you work on it.
...
## Content
Typically, if you have successfully contributed a new function/workflow/... to [dots-hyprland](https://github.com/Kitty-Hivens/YukiUI),
...
## Get this repo
[Fork this repo online](https://github.com/Kitty-Hivens/YukiUI-wiki/fork), and then `git clone` the forked repo to your local machine.
...
### Manage locales
:::caution
This section important if you're adding support for a new language.

Do not skip unless you're just improving existed translation.
:::
...
You must also translate the message in `l10n-notify/l10n-notify.json`, e.g. for `zh-CN`:
