...
- Cross-distro support:
  - Gentoo: brought by [@jwihardi](https://github.com/jwihardi).
  - Fedora: brought by [@ririko6z](https://github.com/ririko6z).
    - Also [@EisregenHaha](https://github.com/EisregenHaha) who had been maintaining a fork for Fedora for about 9 months.
- And [many other people](https://github.com/Kitty-Hivens/YukiUI/graphs/contributors) (also [for doc site](https://github.com/Kitty-Hivens/YukiUI-wiki/graphs/contributors)) whose names are not listed above but also spent their time making this project better than ever.
