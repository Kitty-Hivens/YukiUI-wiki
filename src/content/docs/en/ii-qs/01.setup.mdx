...
```
git clone --recursive https://github.com/Kitty-Hivens/YukiUI && cd dots-hyprland && git checkout 2026.05.11 && ./setup install
```
:::
...
- **Supported by community:**
  - [Gentoo](https://www.gentoo.org/) (see [sdata/dist-gentoo/README.md](https://github.com/Kitty-Hivens/YukiUI/blob/main/sdata/dist-gentoo/README.md) for extra information).
  - [Fedora](https://fedoraproject.org/) (see [sdata/dist-fedora/README.md](https://github.com/Kitty-Hivens/YukiUI/blob/main/sdata/dist-fedora/README.md) for extra information).
...
```bash
bash <(curl -s https://kitty-hivens.github.io/YukiUI-wiki/get) ~/Downloads/dots-hyprland
```
...
```bash
bash <(curl -s https://kitty-hivens.github.io/YukiUI-wiki/get) ~/Downloads/dots-hyprland -- --core
```
